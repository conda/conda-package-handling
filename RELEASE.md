...
[epic template]: https://github.com/conda/conda-package-handling/issues/new?assignees=&labels=epic&template=epic.yml
[compare]: https://github.com/conda/conda-package-handling/compare
[new release]: https://github.com/conda/conda-package-handling/releases/new
...
[Anaconda Recipes]: https://github.com/AnacondaRecipes/conda-package-handling-feedstock
[conda-forge]: https://github.com/conda-forge/conda-package-handling-feedstock
...
[milestone]: https://github.com/conda/conda-package-handling/milestone/<milestone>
[process]: https://github.com/conda/conda-package-handling/blob/main/RELEASE.md
[releases]: https://github.com/conda/conda-package-handling/releases
[main]: https://github.com/AnacondaRecipes/conda-package-handling-feedstock
[conda-forge]: https://github.com/conda-forge/conda-package-handling-feedstock
[ReadTheDocs]: https://readthedocs.com/projects/continuumio-conda-package-handling/
...
- [ ] Ensure release candidates are being successfully built (see `conda-canary/label/conda-conda-package-handling-rc-MAJOR.MINOR.x`)
...
Once the release PRs are filed, successful canary builds will be available on `https://anaconda.org/conda-canary/conda-package-handling/files?channel=conda-conda-package-handling-rc-MAJOR.MINOR.x` for manual testing.

> [!NOTE]
> You do not need to apply the `build::review` label for release PRs; every commit to the release branch builds and uploads canary builds to the respective `conda-conda-package-handling-rc-MAJOR.MINOR.x` label.
...
2. Clone and `cd` into the repository if you haven't done so already:
    ...
    ```bash
    $ git clone git@github.com:/conda-package-handling.git
    $ cd conda-package-handling
    ```
...
To publish the release, go to the project's release page (e.g., https://github.com/conda/conda-package-handling/releases) and add the release notes from `CHANGELOG.md` to the draft release you created earlier. Then publish the release.
