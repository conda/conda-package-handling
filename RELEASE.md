...
Once the release PRs are filed, successful canary builds will be available on `https://anaconda.org/conda-canary/conda/files?channel=rc-conda-package-handling-MAJOR.MINOR.x` for manual testing.
